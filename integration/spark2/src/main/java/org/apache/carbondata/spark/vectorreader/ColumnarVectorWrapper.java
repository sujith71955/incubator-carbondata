...
class ColumnarVectorWrapper implements CarbonColumnVector {
  ...
  @Override public void putBoolean(int rowId, boolean value) {
    if (!filteredRows[rowId]) {
      writableColumnVector.putBoolean(counter++, value);
    }
  }

  @Override public void putFloat(int rowId, float value) {
    if (!filteredRows[rowId]) {
      writableColumnVector.putFloat(counter++, value);
    }
  }

  @Override public void putShort(int rowId, short value) {
    if (!filteredRows[rowId]) {
      writableColumnVector.putShort(counter++, value);
    }
  }
  ...
  @Override public void putShorts(int rowId, int count, short value) {
    if (filteredRowsExist) {
      ...
      writableColumnVector.putShorts(rowId, count, value);
    }
  }

  @Override public void putInt(int rowId, int value) {
    if (!filteredRows[rowId]) {
      writableColumnVector.putInt(counter++, value);
    }
  }
  ...
  @Override public void putInts(int rowId, int count, int value) {
    if (filteredRowsExist) {
      ...
      writableColumnVector.putInts(rowId, count, value);
    }
  }

  @Override public void putLong(int rowId, long value) {
    if (!filteredRows[rowId]) {
      writableColumnVector.putLong(counter++, value);
    }
  }
  ...
  @Override public void putLongs(int rowId, int count, long value) {
    if (filteredRowsExist) {
      ...
      writableColumnVector.putLongs(rowId, count, value);
    }
  }
  ...
  @Override public void putDouble(int rowId, double value) {
    if (!filteredRows[rowId]) {
      writableColumnVector.putDouble(counter++, value);
    }
  }
  ...
  @Override public void putDoubles(int rowId, int count, double value) {
    if (filteredRowsExist) {
      ...
      writableColumnVector.putDoubles(rowId, count, value);
    }
  }

  @Override public void putBytes(int rowId, byte[] value) {
    if (!filteredRows[rowId]) {
      writableColumnVector.putByteArray(counter++, value);
    }
  }
  ...
  @Override public void putNull(int rowId) {
    if (!filteredRows[rowId]) {
      writableColumnVector.putNull(counter++);
    }
  }
  ...
  @Override public void putNulls(int rowId, int count) {
    if (filteredRowsExist) {
      ...
      writableColumnVector.putNulls(rowId, count);
    }
  }

  @Override public boolean isNull(int rowId) {
    return writableColumnVector.isNullAt(rowId);
  }
  ...
  @Override public DataType getType() {
    return CarbonScalaUtil.convertSparkToCarbonDataType(writableColumnVector.dataType());
  }
